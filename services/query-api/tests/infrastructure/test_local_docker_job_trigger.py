...
def test_trigger_full_sweep_invokes_docker_compose_run_without_a_symbol():
    trigger = LocalDockerJobTrigger(project_name="stock-news")
...
def test_trigger_full_sweep_does_not_raise_when_docker_command_fails():
    trigger = LocalDockerJobTrigger(project_name="stock-news")
    ...
    with patch("infrastructure.local_docker_job_trigger.subprocess.run") as mock_run:
        ...
        trigger.trigger_full_sweep()  # does not raise
